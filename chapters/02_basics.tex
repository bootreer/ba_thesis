...
\begin{figure}[H]
  \centering
    ...
    \caption{Structure of PCI configuration space}
    \label{fig:pci-config}
\end{figure}

% \begin{lstlisting}[float,label=lst:sysfs,caption={Example \texttt{sysfs} directory of a PCI device with domain number 0000, bus number 17 and function 0}]
