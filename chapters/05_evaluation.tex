...
\begin{figure}
  \centering
  \subcaptionbox {Threads vs. IOPS; queue depth 32} {\includegraphics[width=0.48\textwidth]{figures/vroom-iops-thread-qd32} \label{fig:vroom-iops-thread-qd32}}
  \subcaptionbox {Queue depth vs. IOPS; single threaded} {\includegraphics[width=0.48\textwidth]{figures/vroom-iops-qd} \label{fig:vroom-iops-qd}}
...
We use the following \texttt{fio} configuration:
