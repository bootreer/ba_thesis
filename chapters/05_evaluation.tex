...
To evaluate whether vroom loses out on performance due to a simpler design and less optimisations we need to benchmark its performance. In this chapter we analyse vroom's performance, i.e. throughput and latency, while comparing it to other I/O engines.
